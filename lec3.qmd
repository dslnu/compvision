...
![](img/linear_image_filtering/regions_convolution.png){width="90%"}
:::
...
![](img/linear_image_filtering/circ_conv.png){width="80%"}
:::
...
![](img/linear_image_filtering/mn4.png){width="70%"}
:::
...
The impulse will be useful in analytical derivations.
...
![LTI system with impulse response $h\left[n\right]$.](img/linear_image_filtering/genericfilterH2.png){width="30%" #fig-genericfilterH}
...
![As shown in the sketch, sounds produced by one speaking person reach a listener via multiple paths. What the person hears is the superposition of all those signals. Figure modified from @TraerE7856.](img/linear_image_filtering/impulse_response_room_a1.png){width="60%" #fig-impulse_response_room_a}
...
![Fig (a) Apparatus used to measure the impulse response generated by a battery-powered speaker and a portable digital recorder. (b) Recorded acoustic impulse response of a room. Figure modified from @TraerE7856.](img/linear_image_filtering/impulse_response_room_a2.png){width="100%" #fig-impulse_response_room_a2}  
...
![Modified from @TraerE7856.](img/linear_image_filtering/impulse_response_room_b.png){width="100%" #fig-impulse_response_room_b}
